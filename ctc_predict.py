...
def audio(sample_image):
    # sample_image = "samples/lost.jpg"
    i = segment.total_images(sample_image)
    SEMANTIC = ''
    ...
    open("static/output/notes.txt", "w").close()
    ...
    for x in range (1,i):
        ...
        for w in str_predictions[0]:
            print (int2word[w]),
            print ('\t'),
            file1 = open("static/output/notes.txt","a")
    ...
    convert_to_audio_file(SEMANTIC)

# CONVERTING TO AUDIO FORMAT

def convert_to_audio_file(SEMANTIC):
    # gets the audio file
    ...
    wavio.write("static\output\output.wav", audio, 44100, sampwidth=2)
    #plays midi 
